...
var foosResource = schema.GroupVersionResource{Group: "nfscontroller.k8s.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "nfscontroller.k8s.io", Version: "v1alpha1", Kind: "Foo"}
